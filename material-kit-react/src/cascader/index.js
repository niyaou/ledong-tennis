...
var Cascade = (function (_super) {
    ...
    function Cascade() {
        ...
        _this.renderItems = function (items) {
            ...
            return (jsxRuntime.jsx("ul", __assign({ className: classNames((_a = {},
                    ...
                    if (Array.isArray(children) && children.length >= 1) {
                        return (jsxRuntime.jsxs("li", __assign({ className: classNames((_a = {},
                    ...
                    return (jsxRuntime.jsx("li", __assign({ "aria-hidden": true, className: classNames((_b = {},
        ...
        _this.renderInput = function () {
            ...
            if (CustomInput)
                return (jsxRuntime.jsx(CustomInput, __assign({}, commonProps, customInputProps), void 0));
            return (jsxRuntime.jsx("input", __assign({}, commonProps), void 0));
        };
        return _this;
    }
    ...
    Cascade.prototype.render = function () {
        ...
        return (jsxRuntime.jsxs("div", __assign({ "aria-hidden": true, className: classNames((_a = {},
