  ...
  return merge(common(env), {
    ...
    devServer: {
      ...
      proxy: {
        ...
        // env dev
        // '/api': {
        //   target: 'http://www.ledongtennis.cn:9968',
        //   pathRewrite: { '^/api': '' },
        //   changeOrigin: true,
        //   secure: false,
        //   headers: {
        //     host: "http://www.ledongtennis.cn:9968",
        ...
        '/api': {
          ...
          secure: false,
          headers: {
            host: "http://124.221.103.110:31168",
            origin: "http://124.221.103.110:31168"
          }
        },
        // '/api': {
        //   target: 'https://www.ledongtennis.cn:9968',
        //   pathRewrite: { '^/api': '' },
        //   changeOrigin: true,
        //   secure: false,
        //   headers: {
        //     host: "https://www.ledongtennis.cn:9968",
        //     origin: "https://www.ledongtennis.cn:9968"
        //   }
        // },
        //env test
        // '/api': {
