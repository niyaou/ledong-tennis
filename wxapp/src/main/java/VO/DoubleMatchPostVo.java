 ...
 *
 */
public class DoubleMatchPostVo implements Serializable {
    private static final long serialVersionUID = -821213610052857928L;
    ...
    @ApiModelProperty(value = "holder2 id")
    private String holder2;
    public static final String HOLDER2 = "holder2";
    public static final String HOLDERNAME2 = "holderName2";
    public static final String HOLDER2AVATOR = "holder2Avator";
    public static final String HOLDER2RANKTYPE0 = "holder2rankType0";
